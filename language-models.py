...
def tokenize(book_string):
    ...
    satisfying the following conditions:
        - The start of every paragraph is be represented in the 
        list with the single character \x02 (standing for START).
        - The end of every paragraph is be represented in the list 
        with the single character \x03 (standing for STOP).
        - Tokens include no whitespace.
        - Whitespace between two paragraphs of text 
          are be ignored.
        - Two or more newlines count are a paragraph break.
        - All punctuation marks count are tokens.
